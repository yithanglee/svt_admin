...
export const load = async ({ fetch, params, parent }) => {
    ...
    let inputs = await genInputs(url, 'CumulativePurchaseFreebie')
    const queryString = buildQueryString({ scope: "get_cumulative_purchase_freebies", id: params["id"] });
    ...
    if (response.ok) {
        ...
        return {
            dataList: dataList,
            id: params['id'],
            module: 'CumulativePurchaseFreebie',
            inputs: inputs
        };
    }
